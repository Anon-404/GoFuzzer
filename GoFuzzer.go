...
boldBlue.Println("╚════════════════════════════════════════════════════╝")
    ...
    boldWhite.Println("  GoFuzzer -a example.com")
    boldWhite.Println("  GoFuzzer -s example.com")
    boldWhite.Println("  GoFuzzer -r example.com")
    boldWhite.Println("  GoFuzzer -d example.com")
    boldWhite.Println("  GoFuzzer -a example.com mylist.txt")
    boldBlue.Println()
